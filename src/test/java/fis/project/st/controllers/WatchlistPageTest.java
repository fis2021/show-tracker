...
class WatchlistPageTest {
    ...
    @Test
    void clickOnCreateTest(FxRobot robot) {
        setup(robot);
    ...
    @Test
    void clickOnViewListTest(FxRobot robot) {
        setup(robot);
        robot.clickOn("#watchlist");
    ...
    @Test
    void watchlistTest(FxRobot robot) {
        setup(robot);
        clickOnMovie(robot);
